				...
				<section className="grid gap-4 md:grid-cols-3">
					<div className="rounded-md border border-slate-200 bg-white p-5">
						...
						<p className="mt-2 text-slate-600 text-sm">
							API envelopes, errors, pagination, IDs, env, and event contracts
							are centralized.
						</p>
					</div>
					<div className="rounded-md border border-slate-200 bg-white p-5">
						...
						<p className="mt-2 text-slate-600 text-sm">
							shadcn primitives stay separate from service-owned design-system
							components.
						</p>
					</div>
					<div className="rounded-md border border-slate-200 bg-white p-5">
						...
						<p className="mt-2 text-slate-600 text-sm">
							Use the rename script to switch display name and slug while
							keeping @repo imports.
						</p>
					</div>
				</section>
				<EmptyState
