...
# Shared lint/type configs live in packages/config:
#   packages/config/biome/{base,node,react}.json
#   packages/config/tsconfig/{base,library,library-react,node-app,nextjs,vite-react,expo}.json
```
